...
class AchievementsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Data Lencana (Trofi)
    final allBadges = [
      {'id': 'beginner', 'name': 'Pemula', 'emoji': '🎯', 'color': AppColors.yellow},
      {'id': 'reader', 'name': 'Pembaca', 'emoji': '📚', 'color': const Color(0xFFFF6B9D)},
      {'id': 'fast', 'name': 'Cepat', 'emoji': '⚡', 'color': const Color(0xFF4ECDC4)},
      {'id': 'streak', 'name': 'Rajin', 'emoji': '🔥', 'color': AppColors.orange},
      {'id': 'writer', 'name': 'Penulis', 'emoji': '✏️', 'color': const Color(0xFFC7CEEA)},
      {'id': 'math', 'name': 'Matematika', 'emoji': '🧮', 'color': const Color(0xFFA8E6CF)},
      {'id': 'master', 'name': 'Master', 'emoji': '👑', 'color': AppColors.yellow},
      {'id': 'genius', 'name': 'Jenius', 'emoji': '🧠', 'color': const Color(0xFFFF6B9D)},
    ];

    // Data Toko
    final shopItems = [
      {'id': 'hat1', 'name': 'Topi Merah', 'emoji': '🎩', 'cost': 50, 'type': 'hat', 'offset_y': -55.0},
      {'id': 'hat2', 'name': 'Mahkota', 'emoji': '👑', 'cost': 100, 'type': 'hat', 'offset_y': -60.0},
      {'id': 'hat3', 'name': 'Wisuda', 'emoji': '🎓', 'cost': 75, 'type': 'hat', 'offset_y': -50.0},
      {'id': 'glasses1', 'name': 'Kacamata', 'emoji': '👓', 'cost': 30, 'type': 'glasses', 'offset_y': -5.0},
      {'id': 'glasses2', 'name': 'Hitam', 'emoji': '🕶️', 'cost': 50, 'type': 'glasses', 'offset_y': -5.0},
      {'id': 'glasses3', 'name': 'Selam', 'emoji': '🥽', 'cost': 45, 'type': 'glasses', 'offset_y': -5.0},
    ];
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: const [
                        Text("Prestasi", style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
                        Text("Koleksi & Kustomisasi", style: TextStyle(color: Colors.white70)),
                      ],
                    ),
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: Stack(
                      ...
                      children: [
                        Text(currentFace, style: const TextStyle(fontSize: 90, height: 1)),
                        if (equippedGlasses != null)
                          Transform.translate(
                            offset: Offset(0, getItemData(equippedGlasses)['offset_y']),
                            child: Text(getItemData(equippedGlasses)['emoji'], style: const TextStyle(fontSize: 50, height: 1)),
                          ),
                        if (equippedHat != null)
                          Transform.translate(
                            offset: Offset(0, getItemData(equippedHat)['offset_y']),
                            child: Text(getItemData(equippedHat)['emoji'], style: const TextStyle(fontSize: 60, height: 1)),
                          ),
                      ],
                    ),
                  ),
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.edit, size: 16, color: AppColors.blue),
                      ),
                    ),
                  ],
                ),
                ...
                Center(
                  child: Container(
                    ...
                    child: Text("$stars Bintang", style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  ),
                ),
                ...
                // 2. PILIHAN WAJAH
                const Text("Pilih Wajah", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isSelected ? AppColors.green.withOpacity(0.2) : Colors.white,
                ...
                // 3. TOKO AKSESORIS
                const Text("Aksesoris", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(height: 12),
                GridView.builder(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final bool isEquipped = (type == 'hat' && equippedHat == id) || (type == 'glasses' && equippedGlasses == id);
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: isEquipped ? Border.all(color: AppColors.green, width: 2) : null,
                              ...
                              if (!isOwned) 
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(children: [const Icon(Icons.star, size: 10), Text(" $cost", style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold))]),
                                  ),
                                )
                              else
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(color: isEquipped ? AppColors.red : AppColors.green, borderRadius: BorderRadius.circular(8)),
                                    child: Text(isEquipped ? "Lepas" : "Pakai", style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
                                  ),
                                ),
                            ],
                          )
                ...
                Row(
                  children: const [
                    ...
                    SizedBox(width: 8),
                    Text("Lemari Trofi", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ],
                ),
                const SizedBox(height: 12),
                GridView.builder(
                    ...
                    return Column(
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(16),
                              boxShadow: isEarned ? [BoxShadow(color: Colors.black.withOpacity(0.05), blurRadius: 5)] : [],
                            ),
                            child: Center(
                              child: Text(
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 10, color: isEarned ? AppColors.textDark : Colors.grey),
