              ...
              child: SingleChildScrollView(
                ...
                child: Builder(
                  builder: (context) {
                    ...
                    // Fallback untuk subject lain
                    return const Center(
                      child: Text("Subject tidak dikenali"),
                    );
                  },
                ),
              ),
...
/// Kartu untuk 1 step berhitung: menampilkan 5 soal sekaligus.
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Kamu salah $wrongCount dari $totalQuestions soal. Silakan ulangi step ini!',
                          style: const TextStyle(
                            color: AppColors.orange,
                            fontWeight: FontWeight.w600,
                          ),
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Hebat! Kamu sudah menguasai step ini!',
                          style: TextStyle(
                            color: AppColors.green,
                            fontWeight: FontWeight.w600,
                          ),
